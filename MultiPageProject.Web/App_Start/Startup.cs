...
using Abp.Hangfire;
using Abp.Owin;
using MultiPageProject.Api.Controllers;
using MultiPageProject.Web;
using Hangfire;
...
namespace MultiPageProject.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in MultiPageProjectWebModule)
