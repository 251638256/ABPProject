...
using MultiPageProject.Web.Controllers.Results;
using MultiPageProject.Web.Models.Account;
...
{
    public class AccountController : MultiPageProjectControllerBase
    {
        ...
        public ActionResult Index() {
            List<User> users = _userManager.Users.Include(c => c.Roles).ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit(long id,string password) {
